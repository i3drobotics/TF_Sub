...
parser.add_argument("--output_dir", help = "output directory for saving recorded video")
...
while(True):
    ...
    if (k == ord('s')):
        if (recording):
            ...
            vid_out = cv2.VideoWriter(args.output_dir+'/output{}.avi'.format(vid_index),fourcc, 10, (frame_width,frame_height), True)
            print("Ready.")
            vid_index += 1
